...
ClippingRectangle {
    ...
    Rectangle {
        ...
        gradient: Gradient {
            GradientStop {
                position: 1
                color: ColorUtils.transparentize(Appearance.material.myBackground, 1)
            }
            GradientStop {
                position: 0
                color: ColorUtils.transparentize(Appearance.material.myBackground, 0.1)
            }
        }
    }
